  ...
  if (void 0 === a.FULLTILT || null === a.FULLTILT) {
    ...
    t.version = "0.5.3", t.getDeviceOrientation = function (a) {
      var b = new Promise(function (b, d) {
        ...
        f.then(function () {
          e._alphaAvailable = l.orientation.data.alpha && null !== l.orientation.data.alpha, e._betaAvailable = l.orientation.data.beta && null !== l.orientation.data.beta, e._gammaAvailable = l.orientation.data.gamma && null !== l.orientation.data.gamma, b(e);
        })["catch"](function () {
      ...
      _betaAvailable: !1,
      _gammaAvailable: !1,
      isAvailable: function isAvailable(a) {
        switch (a) {
          case this.ALPHA:
...
!function (a, b) {
  ...
  var d = "game",
    ...
    v = !1,
    w = function w(a) {};
  return w.GAME = d, w.WORLD = e, w.DEVICE_ORIENTATION = f, w.ACCELERATION = g, w.ACCELERATION_INCLUDING_GRAVITY = h, w.ROTATION_RATE = i, w.prototype.init = function (a) {
    a && a.frequency && (q = a.frequency), a && a.gravityNormalized && (r = a.gravityNormalized), a && a.orientationBase && (s = a.orientationBase), a && "number" == typeof a.decimalCount && a.decimalCount >= 0 && (t = parseInt(a.decimalCount)), a && a.logger && (u = a.logger), a && a.screenAdjusted && (v = a.screenAdjusted);
    var b = new FULLTILT.getDeviceOrientation({
      ...
      c = new FULLTILT.getDeviceMotion().then(function (a) {
        p = a, l = p.getScreenAdjustedAccelerationIncludingGravity().z > 0 ? -1 : 1;
      });
...
/***/ "./src/sections/wgl-banner/styles.css":
/*!********************************************!*\
  !*** ./src/sections/wgl-banner/styles.css ***!
  \********************************************/
...
/* harmony export */ });
/* harmony import */ var _static_lib_gyronorm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../static/lib/gyronorm.js */ "./static/lib/gyronorm.js");
/* harmony import */ var _static_lib_gyronorm_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_static_lib_gyronorm_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.css */ "./src/sections/wgl-banner/styles.css");
...
var gn = new (_static_lib_gyronorm_js__WEBPACK_IMPORTED_MODULE_0___default().GyroNorm)();
var Sketch = /*#__PURE__*/function () {
  ...
  return _createClass(Sketch, [{
    ...
    value: function start(images) {
      ...
      var u_image1Location = this.gl.getUniformLocation(this.program, "image1");
...
/******/ })()
;
//# sourceMappingURL=wgl-banner.bundle.js.map