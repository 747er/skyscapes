...
"use strict";
/*!*****************************************!*\
  !*** ./src/sections/gallery/gallery.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
var GRID_SELECTOR = '#gallery--photoswipe-gallery';
var ITEM_SELECTOR = '.grid-item';
...
function initializeGalleryWhenReady() {
  ...
  if (!grid) {
    console.warn("Cannot find grid container \"".concat(GRID_SELECTOR, "\"."));
    return;
  }
  var galleryElements = getGalleryElements();
...
function getGalleryElements() {
  return document.querySelectorAll("".concat(GRID_SELECTOR, " ").concat(ITEM_SELECTOR));
}
function initializeGallery(grid) {
  imagesloaded__WEBPACK_IMPORTED_MODULE_4___default()(grid, function () {
    // Initialize Masonry
    var msnry = new (masonry_layout__WEBPACK_IMPORTED_MODULE_3___default())(grid, {
